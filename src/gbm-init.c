...
extern SEXP gbm_shrink_gradient(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP gbm_shrink_pred(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);

static const R_CallMethodDef CallEntries[] = {
  {"gbm_fit",             (DL_FUNC) &gbm_fit,             22},
  {"gbm_plot",            (DL_FUNC) &gbm_plot,            10},
  {"gbm_pred",            (DL_FUNC) &gbm_pred,            10},
  {"gbm_shrink_gradient", (DL_FUNC) &gbm_shrink_gradient, 12},
  {"gbm_shrink_pred",     (DL_FUNC) &gbm_shrink_pred,     11},
  {NULL, NULL, 0}
};
